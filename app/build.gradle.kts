...
android {
    namespace = "com.example.spaceup"
    compileSdk = 36
    
    signingConfigs {
        create("release") {
            storeFile = file("spaceup-release-key.jks")
    ...
    defaultConfig {
        applicationId = "com.example.spaceup"
        minSdk = 24
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
    ...
    buildTypes {
        release {
            ...
            // Tự động ký nếu file khóa tồn tại trong thư mục app
            if (file("spaceup-release-key.jks").exists()) {
